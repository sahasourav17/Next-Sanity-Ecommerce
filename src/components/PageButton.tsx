...
const PageButton = () => {
  return (
    <div className="fixed top-60 right-2 z-20 flex flex-col gap-2">
      <Link
        href={"/profile"}
        className="bg-white w-16 h-[70px] rounded-md flex flex-col gap-1 text-primeColor justify-center items-center shadow-testShadow overflow-x-hidden group cursor-pointer"
      >
